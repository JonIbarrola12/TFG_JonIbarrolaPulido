...
namespace SportsHome.IL.Repository.EF.Migrations
{
    ...
    [Migration("20260412152936_Crear_tabla_Usuarios")]
    partial class Crear_tabla_Usuarios
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SportsHome.Core.Entities.Clasificaciones", b =>
                {
                    b.Property<int>("ClasificacionId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    MySqlPropertyBuilderExtensions.UseMySqlIdentityColumn(b.Property<int>("ClasificacionId"));
                    ...
                    b.HasIndex("LigaId", "EquipoId", "Temporada")
                        .IsUnique();

                    b.HasIndex("LigaId", "Temporada", "Posicion");
            ...
            modelBuilder.Entity("SportsHome.Core.Entities.SyncLogs", b =>
                {
            ...
            modelBuilder.Entity("SportsHome.Core.Entities.Usuarios", b =>
                {
